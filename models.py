...
class TransferNet(nn.Module):
    def __init__(self, num_class, base_net='resnet50', transfer_loss='mmd', use_bottleneck=True, bottleneck_width=512,
    ...
    def forward(self, source, target, source_label):
        ...
        # transfer_loss = 0.4 * transfer_loss1 + 0.6 * transfer_loss2  # 91.6667
        # transfer_loss = 0.3 * transfer_loss1 + 0.7* transfer_loss2  # 91.5000
