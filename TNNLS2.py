...
def get_parser(source, target, model, backbone):
    ...
    # parser.add_argument('--data_dir', type=str, default='./datasets/SkinCancer/')
...
if __name__ == "__main__":
    main('train', 'valid', name='21.csv', model= 'DSAN/DSAN.yaml', backbone = 'resnet34')
    main('train', 'valid', name='22.csv', model= 'BNM/BNM.yaml', backbone = 'resnet34')
    # main('train', 'valid', name='23.csv', model='DANN/dann.yaml', backbone='googlenet')
    # main('train', 'valid', name='24.csv', model='DAN/DAN.yaml', backbone='googlenet')
    # main('train', 'valid', name='25.csv', model='DANN/dann.yaml', backbone='vgg')
    # main('train', 'valid', name='26.csv', model='DAN/DAN.yaml', backbone='vgg')
    # main('train', 'valid', name='27.csv', model='DANN/dann.yaml', backbone='resnet34')
    # main('train', 'valid', name='28.csv', model='DAN/DAN.yaml', backbone='resnet34')
    # main('train', 'valid', name='29.csv', model='DANN/dann.yaml', backbone='resnet50')
    # main('train', 'valid', name='30.csv', model='DAN/DAN.yaml', backbone='resnet50')
    # main('train', 'valid', name='31.csv', model='DANN/dann.yaml', backbone='resnet101')
    # main('train', 'valid', name='32.csv', model='DAN/DAN.yaml', backbone='resnet101')
    # main('train', 'valid', name='33.csv', model='DANN/dann.yaml', backbone='densenet')
    # main('train', 'valid', name='34.csv', model='DAN/DAN.yaml', backbone='densenet')
    # main('train', 'valid', name='35.csv', model='DANN/dann.yaml', backbone='shuffle')
    # main('train', 'valid', name='36.csv', model='DAN/DAN.yaml', backbone='shuffle')
    # main('train', 'valid', name='37.csv', model='DANN/dann.yaml', backbone='efficient')
    # main('train', 'valid', name='38.csv', model='DAN/DAN.yaml', backbone='efficient')
    # main('train', 'valid', name='39.csv', model='DANN/dann.yaml', backbone='mnasnet')
    # main('train', 'valid', name='40.csv', model='DAN/DAN.yaml', backbone='mnasnet')
